...
class Ui_DialogLogin(object):
    def setupUi(self, DialogLogin):
        ...
        self.login_error_label.setAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, DialogLogin):
        ...
        self.label.setText(_translate("DialogLogin", "长沙瑞财科技有限公司", None))
        self.uiVersionLbl.setText(_translate("DialogLogin", "发票助手 V2.0", None))
