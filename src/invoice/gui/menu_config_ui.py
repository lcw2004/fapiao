...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_3.addWidget(self.reviewer_lineEdit, 2, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.beneficiary_lineEdit, 1, 2, 1, 1)
        self.label_10 = QtGui.QLabel(self.gridGroupBox1)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.gridLayout_3.addWidget(self.label_10, 0, 0, 1, 1)
        self.invoice_code_lineEdit = QtGui.QLineEdit(self.gridGroupBox1)
        self.invoice_code_lineEdit.setObjectName(_fromUtf8("invoice_code_lineEdit"))
        self.gridLayout_3.addWidget(self.invoice_code_lineEdit, 0, 2, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_10.setText(_translate("Dialog", "发票代码：", None))
