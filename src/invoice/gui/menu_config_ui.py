...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_3 = QtGui.QGridLayout(self.gridGroupBox1)
        self.gridLayout_3.setMargin(9)
        self.gridLayout_3.setObjectName(_fromUtf8("gridLayout_3"))
        self.label_8 = QtGui.QLabel(self.gridGroupBox1)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.gridLayout_3.addWidget(self.label_8, 0, 0, 1, 1)
        self.label_9 = QtGui.QLabel(self.gridGroupBox1)
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.gridLayout_3.addWidget(self.label_9, 1, 0, 1, 1)
        self.reviewer_lineEdit = QtGui.QLineEdit(self.gridGroupBox1)
        self.reviewer_lineEdit.setObjectName(_fromUtf8("reviewer_lineEdit"))
        self.gridLayout_3.addWidget(self.reviewer_lineEdit, 1, 1, 1, 1)
        self.beneficiary_lineEdit = QtGui.QLineEdit(self.gridGroupBox1)
        self.beneficiary_lineEdit.setObjectName(_fromUtf8("beneficiary_lineEdit"))
        self.gridLayout_3.addWidget(self.beneficiary_lineEdit, 0, 1, 1, 1)
        self.verticalLayout.addWidget(self.gridGroupBox1)
        self.gridGroupBox2 = QtGui.QGroupBox(Dialog)
        self.gridGroupBox2.setObjectName(_fromUtf8("gridGroupBox2"))
        self.gridLayout_2 = QtGui.QGridLayout(self.gridGroupBox2)
        self.gridLayout_2.setContentsMargins(9, 9, -1, -1)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.label_3 = QtGui.QLabel(self.gridGroupBox2)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout_2.addWidget(self.label_3, 0, 0, 1, 1)
        self.label_4 = QtGui.QLabel(self.gridGroupBox2)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.gridLayout_2.addWidget(self.label_4, 3, 0, 1, 1)
        self.temp_img_font_size_lineEdit = QtGui.QLineEdit(self.gridGroupBox2)
        ...
        self.temp_img_font_lineEdit = QtGui.QLineEdit(self.gridGroupBox2)
        self.temp_img_font_lineEdit.setObjectName(_fromUtf8("temp_img_font_lineEdit"))
        self.gridLayout_2.addWidget(self.temp_img_font_lineEdit, 0, 1, 1, 1)
        ...
        Dialog.setTabOrder(self.end_num_lineEdit, self.temp_img_font_size_lineEdit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.gridGroupBox1.setTitle(_translate("Dialog", "默认信息", None))
        self.label_8.setText(_translate("Dialog", "收款人：", None))
        self.label_9.setText(_translate("Dialog", "复核人：", None))
        self.gridGroupBox2.setTitle(_translate("Dialog", "发票模板", None))
