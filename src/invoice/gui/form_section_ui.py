...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.user_name_comboBox = QtGui.QComboBox(Dialog)
        self.user_name_comboBox.setObjectName(_fromUtf8("user_name_comboBox"))
        self.gridLayout.addWidget(self.user_name_comboBox, 2, 2, 1, 1)
        ...
        Dialog.setTabOrder(self.end_num_LineEdit, self.buttonBox)
